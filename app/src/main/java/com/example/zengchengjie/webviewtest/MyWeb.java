...
public class MyWeb extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mwebView.addJavascriptInterface(new MyJs(), "my");//添加一个JavaScript的接口
...
//        mwebView.loadUrl("file:///android_assert/index.html");//将网址传入
        mwebView.loadUrl("http://www.chsi.com.cn/xlcx/lscx.jsp");//将网址传入
